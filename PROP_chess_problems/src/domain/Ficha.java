...
public class Ficha {
	...
	/**
	 * Devuelve una ficha nueva según los parámetros proporcionados
	 * @param f String que indica en minúsculas que tipo de ficha es
	 * @param color String que indica qué color es
	 * @return nuevo objeto FichaX según los parámetros proporcionados
	 */
	...
	/**
	 * Devuelve una ficha nueva según el parámetro proporcionado
	 * @param f String de la ficha según anotación FEN
	 * @return nuevo objeto FichaX según el parámetro proporcionado
	 */
	...
	/**
	 * Consulta el carácter de la Ficha en formato FEN
	 * @return Devuelve un String con el carácter de la Ficha en formato FEN
	 */
	...
	/**
	 * Consulta los posibles movimientos que puede ralizar la Ficha en una determinada posición
