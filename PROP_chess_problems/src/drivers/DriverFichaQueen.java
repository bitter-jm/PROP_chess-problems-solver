...
public class DriverFichaQueen {
	...
	public static void main(String[] args) {
		...
		while (!exit) {			
			...
			System.out.println(" -1- Crear Ficha Queen");
			...
			case 1:
				...
				f = new FichaQueen(sc.next());
				if (f != null) System.out.println("Objeto FichaQueen creado con color \"" + f.color + "\"");
				break;
			case 2:
				...
				System.out.println("Indica las coordenadas de FichaQueen a analizar (de arriba a abajo, izquierda a derecha): ");
				i = sc.nextInt();
				j = sc.nextInt();
				if (casillas[i][j] == null || !casillas[i][j].ficha.equals("q")) {
					System.out.println("No hay un Queen en esas coordenadas");
					break;
				}
