...
public class DriverFichaKnight {
	...
	public static void main(String[] args) {
		...
		while (!exit) {			
			...
			System.out.println(" -1- Crear Ficha Knight");
			...
			case 1:
				...
				f = new FichaKnight(sc.next());
				if (f != null) System.out.println("Objeto FichaKnight creado con color \"" + f.color + "\"");
				break;
			case 2:
				...
				System.out.println("Indica las coordenadas de FichaKnight a analizar (de arriba a abajo, izquierda a derecha): ");
				i = sc.nextInt();
				j = sc.nextInt();
				if (casillas[i][j] == null || !casillas[i][j].ficha.equals("n")) {
					System.out.println("No hay un Knight en esas coordenadas");
					break;
				}
