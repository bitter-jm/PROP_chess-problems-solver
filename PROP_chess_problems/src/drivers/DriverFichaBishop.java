...
public class DriverFichaBishop {
	...
	public static void main(String[] args) {
		...
		while (!exit) {			
			...
			System.out.println(" -1- Crear Ficha Bishop");
			...
			case 1:
				...
				f = new FichaBishop(sc.next());
				if (f != null) System.out.println("Objeto FichaBishop creado con color \"" + f.color + "\"");
				break;
			case 2:
				...
				System.out.println("Indica las coordenadas de FichaBishop a analizar (de arriba a abajo, izquierda a derecha): ");
				i = sc.nextInt();
				j = sc.nextInt();
				if (casillas[i][j] == null || !casillas[i][j].ficha.equals("b")) {
					System.out.println("No hay un Bishop en esas coordenadas");
					break;
				}
