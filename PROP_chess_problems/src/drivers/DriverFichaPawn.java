...
public class DriverFichaPawn {
	...
	public static void main(String[] args) {
		...
		while (!exit) {			
			...
			System.out.println(" -1- Crear Ficha Pawn");
			...
			case 1:
				...
				f = new FichaPawn(sc.next());
				if (f != null) System.out.println("Objeto FichaPawn creado con color \"" + f.color + "\"");
				break;
			case 2:
				...
				System.out.println("Indica las coordenadas de FichaPawn a analizar (de arriba a abajo, izquierda a derecha): ");
				i = sc.nextInt();
				j = sc.nextInt();
				if (casillas[i][j] == null || !casillas[i][j].ficha.equals("p")) {
					System.out.println("No hay un Pawn en esas coordenadas");
					break;
				}
